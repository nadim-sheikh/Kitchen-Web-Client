...
const FoodItemHome = ({ foodItem }) => {
    const { title, image, rating, details, price } = foodItem;
            ...
            <div className="card-body">
               ...
               <p className='font-semibold text-gray-500'>Rating:<span className='font-semibold text-orange-400'>{rating}</span></p>
                <div className="card-actions justify-end">
                    <button className="bg-orange-400 hover:bg-orange-600  duration-300 py-3 px-5 rounded-md font-semibold text-white">Buy Now</button>
                </div>
